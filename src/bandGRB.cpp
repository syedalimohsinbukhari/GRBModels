...
vd bandEpeak(const vd &energy,
             const double_t amplitude, const double_t peakEnergy, const double_t lowIndex, const double_t highIndex,
...
vd bandE0(const vd &energy,
          const double_t amplitude, const double_t breakEnergy, const double_t lowIndex, const double_t highIndex, const double_t pivotEnergy) {
    const double_t peakEnergy = (2 + lowIndex) * breakEnergy;
